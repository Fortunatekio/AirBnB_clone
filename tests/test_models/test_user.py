...
class TestUser(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.my_user = User()
        cls.my_user.first_name = "Fortu"
        cls.my_user.last_name = "Alex"
        cls.my_user.email = "airbnb@fortualex.com"
        cls.my_user.password = "code"
    ...
    def test_is_subclass(self):
        elf.assertTrue(issubclass(self.my_user.__class__, BaseModel), True)
